...
import com.ll.exam.app.member.controller.MemberController;
...
class AppApplicationTests {
	...
	@Test
	@DisplayName("user1로 로그인 후, 프로필페이지에 접속하면 user1의 이메일이 보여야한다")
	...
	@Test
	@DisplayName("user4로 로그인 후, 프로필페이지에 접속하면 user4의 이메일이 보여야한다")
